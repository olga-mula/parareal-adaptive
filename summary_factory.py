...
from parareal_factory import Parareal_Algorithm

def summary_run(eps, k, p, pl, fl, gl, folder_name):
  """Summary of performance of the parareal run.
  ...
  print('=====================')
  print('Saving data in '+folder_name)
  err = p.compute_error()
  ...
  plt.figure()
  e = list()
  t = np.linspace(p.ti, p.tf, num=p.N+1, endpoint=True)
  for para in p.pl:
