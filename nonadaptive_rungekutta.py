...
class NonAdaptiveRungeKutta(OdeSolver):
	...
	def __init__(self, fun, t0, y0, t_bound, max_step=np.inf,
		...
		super(NonAdaptiveRungeKutta, self).__init__(fun, t0, y0, t_bound, vectorized, support_complex=True)
		self.y_old = None
...
class NonAdaptiveRK23(NonAdaptiveRungeKutta):
...
class NonAdaptiveRK45(NonAdaptiveRungeKutta):
